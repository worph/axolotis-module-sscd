...
var s=()=>new inversify.AsyncContainerModule(async o=>{o(chunkS7CYAWJ7_cjs.a).toDynamicValue(async()=>{let e=await import('./SimpleCollisionDetection-6ECZPPP5.cjs');return new e.SimpleCollisionDetection}).inSingletonScope();}),t=class{getModule(){return new inversify.AsyncContainerModule(async e=>{e(chunkS7CYAWJ7_cjs.a).toDynamicValue(async()=>{let r=await import('./SimpleCollisionDetection-6ECZPPP5.cjs');return new r.SimpleCollisionDetection}).inSingletonScope();})}};
